...
# tmp = os.path.join(now_dir, "work_dir")
...
with gr.Blocks(title="Medlive-数字人") as app:
    gr.Markdown(
        value=
            i18n("欢迎光临医脉通数字人生成系统 <br>数字人--声音克隆部分<b></b>.")
    )
    with gr.Tabs():
        with gr.TabItem(i18n("人声提取")):
            with gr.Group():
                gr.Markdown(
                    value=i18n(
